...
export const registerBodySchema = z
  .object({
    ...
    password: z
      .string()
      .trim()
      .min(6, { error: 'Mật khẩu tối thiểu 6 kí tự' })
    ...
    name: z.string().trim().max(100, { error: 'Tên không được dài quá 100 kí tự' }).optional(),
    date_of_birth: z.coerce.date({ error: 'Ngày sinh không đúng định dạng (YYYY-MM-DD)' }).optional()
  })
